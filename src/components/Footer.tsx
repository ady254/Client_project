                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-5">
                            <a href="https://www.instagram.com/metalstickersindia/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-none bg-white/5 border border-white/10 flex items-center justify-center text-[#E4405F] hover:bg-[#E4405F]/10 hover:border-[#E4405F]/50 transition-all duration-300">
                            ...
                            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-none bg-white/5 border border-white/10 flex items-center justify-center text-[#0077B5] hover:bg-[#0077B5]/10 hover:border-[#0077B5]/50 transition-all duration-300">
                            ...
                            <a href="https://wa.me/919999865558" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-none bg-white/5 border border-white/10 flex items-center justify-center text-[#25D366] hover:bg-[#25D366]/10 hover:border-[#25D366]/50 transition-all duration-300">
                            ...
                            <a href="https://www.youtube.com/@METALSTICKERSFACTORYFARIDABAD" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-none bg-white/5 border border-white/10 flex items-center justify-center text-[#FF0000] hover:bg-[#FF0000]/10 hover:border-[#FF0000]/50 transition-all duration-300">
